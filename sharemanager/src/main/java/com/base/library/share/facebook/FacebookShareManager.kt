 ...
 * Date:    2018/12/4
 */
class FacebookShareManager(private val activity: Activity, private val onShareListener: OnShareListener) :
    ...
    override fun onSuccess(result: Sharer.Result?) {
        ...
        onShareListener.onShareSuccess(ShareConstants.FACEBOOK)
    }

    override fun onCancel() {
        ShareUtils.clearShareTempPictures(activity)
        onShareListener.onShareFail(ShareConstants.FACEBOOK, "Facebook share cancel")
    }
